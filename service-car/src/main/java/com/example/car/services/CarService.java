...
public class CarService {
    ...
    public List<CarResponse> findAll() {
        ...
        ResponseEntity<Client[]> response = restTemplate.getForEntity(this.URL + "/clients", Client[].class);
    ...
    public CarResponse findById(Long id) throws Exception {
        ...
        Client client = restTemplate.getForObject(this.URL + "/clients/" + car.getClient_id(), Client.class);
        return CarResponse.builder()
                .id(car.getId())
                .brand(car.getBrand())
                .client(client)
